...
func messageCreateHandler(conf *config.Config, client http.Client, url string) api.ProxyHandler[discord.MessageCreate, *fluxer.Message] {
	return api.ProxyHandler[discord.MessageCreate, *fluxer.Message]{
		Conf:   conf,
		Client: client,
		Path:   url,
